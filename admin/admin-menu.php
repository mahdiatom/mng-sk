...
function sc_register_admin_menu() {
   ...
   add_menu_page(
    ...
    add_submenu_page(
        ...
        'manage_options',
        'sc-penalty-test',
        'sc_penalty_test_callback'
    );
    
    // Recurring Invoices Test
    add_submenu_page(
        'sc-dashboard',
        'تست صورت حساب تکراری',
        'تست صورت حساب تکراری',
        'manage_options',
        'sc-recurring-invoices-test',
        'sc_recurring_invoices_test_callback'
    );
...
/**
 * Penalty Test Callback
 */
function sc_penalty_test_callback(){
    include SC_INCLUDES_DIR . 'penalty-test.php';
}

/**
 * Recurring Invoices Test Callback
 */
function sc_recurring_invoices_test_callback(){
    include SC_INCLUDES_DIR . 'recurring-invoices-test.php';
}
