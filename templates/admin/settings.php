                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">متغیرهای قابل استفاده: %user_name%, %course_name%, %amount%, %due_date%</p>
                            <br>
                            <input type="number"
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">متغیرهای قابل استفاده: %user_name%, %course_name%, %date%</p>
                            <br>
                            <input type="number"
