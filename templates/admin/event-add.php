...
<div class="wrap">
    ...
    <h1 class="wp-heading-inline">
      ...
      <p>در صورتی که میخواهید یک  مسابقه یا رویدادی برگزار کنید که افرادی خارج از بازیکن های باشگاه نیز امکان ثبت نام داشته باشند ( برای اینکه نخواهند در سیستم ورود کنند و سپس ثبت نام رویداد را انجام دهند )  میتوانید رویداد عمومی را فعال کنید تا برای آن رویداد یک صفحه عمومی ساخته شود . در  این حالت اگر کاربر  در سایت عضو نباشد نیز امکان ثبت نام دارد و همچنین بازیکن های مجموعه هم بدون وارد شدن به پنل  میتوانند در این  رویداد شرکت کنند . معیار شناسایی کاربران سیستم کدملی بازیکن است.</p>
    <?php 
