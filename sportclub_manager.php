...
function sc_check_and_create_tables() {
    ...
    if (!$metric_fields_exists && function_exists('sc_create_metric_fields_table')) {
...
function sc_public_enqueue_assets() {
    ...
    $sc_is_daily_metrics = !is_admin()
        && $sc_is_panel
        && (
            ($sc_req_uri !== '' && strpos($sc_req_uri, 'sc-daily-metrics') !== false)
            || (is_object($wp) && isset($wp->query_vars['sc-daily-metrics']))
            || (function_exists('is_wc_endpoint_url') && is_wc_endpoint_url('sc-daily-metrics'))
            || get_query_var('sc-daily-metrics', false) !== false
            || (function_exists('sc_panel_active_tab_is') && sc_panel_active_tab_is('sc-daily-metrics'))
        );
